...
public class SmartDatabase{
   ...
   * @param exclude The list of things that must be excluded.
   * @param type The cuisine type of the Recipe.
   * @return The meal plan we have found that satisfies the conditions.
   */
  public String plan(int time, ArrayList<String> include, ArrayList<String> exclude, String type){
    ...
    if(entree!=null){
      ...
      if(salad1!=null){
        ...
        if(salad2!=null){
          ...
          if(appetizer!=null){
            String output = entree.getInfo()+"\n";
            output = output+salad1.getInfo()+"\n";
            output = output + salad2.getInfo()+"\n";
            output = output + appetizer.getInfo()+"\n";
            return output;
          }
        }
      }
    }
    return "I'm sorry, I could not find find something that satisfies your conditions.";
  }
